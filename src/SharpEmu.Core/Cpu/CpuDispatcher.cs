...
public sealed class TrackedCpuMemory : ICpuMemory, ITrackedCpuMemory, IGuestMemoryAllocator, ICpuMemoryWrapper
{
    ...
    public bool TryRead(ulong virtualAddress, Span<byte> destination)
    {
        ...
        LastFailure = result ? null : new CpuMemoryAccessFailure(virtualAddress, destination.Length, isWrite: false);
        return result;
    }
    ...
    public bool TryWrite(ulong virtualAddress, ReadOnlySpan<byte> source)
    {
        ...
        LastFailure = result ? null : new CpuMemoryAccessFailure(virtualAddress, source.Length, isWrite: true);
        return result;
    }
